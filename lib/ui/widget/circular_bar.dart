...
class CircularProgressb extends StatefulWidget{
  ...
  final Color color;
  CircularProgressb({@required this.size, this.backgroundColor = Colors.grey, this.color = Colors.blue, this.progress});
...
class _CircularProgressb extends State<CircularProgressb> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    controller = new AnimationController(vsync: this, duration: const Duration(milliseconds: 1000))..forward();
  ...
  Widget build(BuildContext context) {
    ...
    return new Stack(
      ...
      children: <Widget>[
        ...
        new Text('${(animation.value).round()}°C',
